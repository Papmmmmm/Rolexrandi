...
bot = telebot.TeleBot('7391676661:AAEHac7D3zvO0sxkSXIEJs5GA93CDVqCtF4')
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "🚫 Unauthorized Access!🚫Please buy access :-@ROLEX_OWNER_HU"
...
def welcome_start(message):
    ...
    response = f'''🫡WELCOME TO ROLEX VIP DDOS BOT 🚀 '''
    bot.reply_to(message, response)
...
def welcome_rules(message):
    user_name = message.from_user.first_name
    response = f'''
1. ANY PROBLEM DM HERE -> @ROLEX_OWNER_HU'''
    bot.reply_to(message, response)
